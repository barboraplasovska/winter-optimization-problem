...
def getSnowplowDistance(placeName):
...
d = getSnowplowDistance("Outremont, Montreal")
d += getSnowplowDistance("Verdun, Montreal")
d += getSnowplowDistance("Saint-Leonard, Montreal")
d += getSnowplowDistance("Riviere-des-prairies-pointe-aux-trembles, Montreal")
d += getSnowplowDistance("Le Plateau-Mont-Royal, Montreal")
